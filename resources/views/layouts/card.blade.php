<div class="col-sm-6 col-md-4">
    <div class="thumbnail">
        ...
        <img style="height: 150px;" src="{{--{{ url('storage/'.$product->image) }}--}} {{ url('storage/'.$sku->product->image) }}" alt="{{ $sku->product->__('name') }}">
        <div class="caption">
            <h3 style="color: darkblue;">{{ $sku->product->__('name') }}</h3>
