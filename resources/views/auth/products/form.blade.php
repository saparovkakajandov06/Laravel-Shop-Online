    ...
    <div style="margin-top: 10%; color: #2c2172;" class="col-md-12">
        ...
        >
            <div>
                ...
                <br>
                <div class="input-group row">
                    <label for="name" class="col-sm-2 col-form-label">Ady: </label>
                    <div class="col-sm-6">
                ...
                <br>
                    <div class="input-group row">
                        <label for="name" class="col-sm-2 col-form-label">Haryt ady: </label>
                        <div class="col-sm-6">
                ...
                <br>
                <div class="input-group row">
                    <label for="description" class="col-sm-2 col-form-label">Mazmuny: </label>
                    <div class="col-sm-6">
                ...
                <br>
                    <div class="input-group row">
                        <label for="description" class="col-sm-2 col-form-label">Harydyň mazmuny: </label>
                        <div class="col-sm-6">
